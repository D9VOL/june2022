...
//     nameSurname.innerText = simpson.name + " " + simpson.surname + " " + simpson.age;
...
//     secondBlock.classList.add('second');
...
//     secondBlock.appendChild(monthDuration);
//
//     let hourDuration = document.createElement('p');
//     hourDuration.innerText = 'Hour Duration' + " --- " + element.hourDuration;
//     secondBlock.appendChild(hourDuration);
//
//     let thirdBlock = document.createElement('ul');
//     thirdBlock.classList.add('third');
//     div.appendChild(thirdBlock);
//
//     for (const item of element.modules) {
//
//         let modul = document.createElement('li');
//         modul.innerText = item;
//         thirdBlock.appendChild(modul);
//
//     }
//
...
// let div = document.createElement('div');
// div.classList.add('main','wrap','collapse','alpha','beta');
//
// let title = document.createElement('h2');
